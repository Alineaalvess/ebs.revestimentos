  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        ...
        <span className="text-blue-400">EBS REVEST</span>
        </h1>
        <p className="text-lg md:text-2xl text-slate-200 max-w-3xl mx-auto mb-10 leading-relaxed">
        Somos especialistas em revestimentos de cilindros para máquinas offset e indústrias. Tecnologia de ponta com revestimentos de alta performance para sua empresas.
        </p>
